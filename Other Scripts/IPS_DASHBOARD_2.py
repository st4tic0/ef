...
filtrado['Gas_Anual'] = filtrado['gas_mmcfpd'] * filtrado['dias']
...
with st.expander('Production Data'):
    ...
    map_all_data.update_layout(mapbox_style="open-street-map", margin={"r":0,"t":0,"l":0,"b":0}, height=600, width=1510)
    ...
    field_prod.add_trace(go.Scatter(x=fil['Year'],y=fil['Aceite_Anual'], mode='markers', marker_line_width=.5, marker=dict(size=4,color='green'),name='Oil'), secondary_y=False)
    field_prod.add_trace(go.Scatter(x=fil['Year'],y=fil['Gas_Anual'], mode='markers', marker_line_width=.5, marker=dict(size=4,color='red'), name='Gas'), secondary_y=False)
    field_prod.add_trace(go.Scatter(x=fil['Year'],y=fil['water_cut1'],mode='markers', marker_line_width=.5,marker=dict(size=4,color='blue'),name='Water<br>Cut'), secondary_y=True)
    ...
    ##OIL##
    oil = px.scatter(filtrado, x= filtrado.index, y="aceite_bpd", log_y=True, color="terminacion")
    ...
    ##GAS##
    gas = px.scatter(filtrado, x= filtrado.index, y="gas", log_y=True, color="terminacion")
    ...
    ##WATER PROD##
    w_prod = px.scatter(filtrado, x= filtrado.index, y="agua_bpd", log_y=True, color="terminacion")
    ...
    ##WATER_CUT##
    w_cut = px.scatter(filtrado, x= filtrado.index, y="water_cut", log_y=True, color="terminacion")
    ...
    ##PRESS 1##
    press_1 = px.scatter(filtrado_press, x= filtrado_press.index, y="cerrado(yac)", log_y=True, color="terminacion")
    ...
    ##PRESS 2##
    press_2 = px.scatter(filtrado_press, x= filtrado_press.index, y="cerrado(pozo)", log_y=True, color="terminacion")
    ...
    ##PRESS 3##
    press_3 = px.scatter(filtrado_press, x= filtrado_press.index, y='fluyendo(yac)', log_y=True, color="terminacion")
    ...
    ##PRESS 4##
    press_4 = px.scatter(filtrado_press, x= filtrado_press.index, y='fluyendo(pozo)', log_y=True, color="terminacion")
...
######################################################################################################
    ...
    well_prod.add_trace(go.Scatter(x=data1['fecha'], y=data1['gas_mmcfpd'], mode='markers', marker_line_width=.5, marker=dict(size=4,color='red'), name='Gas'), secondary_y=False)
    well_prod.add_trace(go.Scatter(x=data1['fecha'], y=data1['aceite_bpd'], mode='markers', marker_symbol = 'triangle-up', marker_line_width=.5, marker=dict(size=5,color='blue'),name='Water<br>Cut'),secondary_y=True)

    well_prod.add_trace(go.Scatter(x=data2.index,y=data2['Open'],mode='markers',marker_line_width=.5,marker=dict(size=5,color='purple'),name='Open'),secondary_y=False,)
    ...
    well_prod.add_trace(go.Scatter(x=data2.index,y=data2['Reentry'],mode='markers',marker_line_width=.5,marker=dict(size=5,color='cyan'),name='Reentry'),secondary_y=False,)
    
    well_prod.add_trace(go.Scatter(x=data1['fecha'],y=data1['Historical trend'],mode='markers',marker_line_width=.5,marker=dict(size=2,color='black'),name='Trend'),secondary_y=False,)

    # Set x-axis title
    well_prod.update_layout(hovermode="x unified")
    well_prod.update_xaxes(title_text="<b>Year</b>")
    well_prod.update_layout(margin={"r":0,"t":50,"l":0,"b":0}, height=500, width=1500)
    
    # Set y-axes titles
    well_prod.update_layout(yaxis1=dict(type='log'))
    
    # update
    well_prod.update_yaxes(title_text="<b>Oil (BOPD) / Gas (MMCFPD)</b> ", secondary_y=False)
    well_prod.update_yaxes(title_text="<b>Fw %</b>", secondary_y=True)
    ...
    st.caption("Cum Gas: " + str(round(cum_gas,2)) + " MMCFPD")
...
with st.expander('Water Control Diagnostic Plots'):
    ...
    salt_mont = px.scatter(filtrado_salt_month, x=filtrado_salt_month.index, y="salinidad", log_y=True, color="terminacion", width=1510)
...
######################################################################################################
    ...
    salt_plt.add_trace(go.Scatter(x=filtrado_salt['fecha'],y=filtrado_salt['water_cut'],mode='lines', marker_line_width=.5,marker=dict(size=4,color='blue'),name='Water<br>Cut'), secondary_y=True)
    
    # Set x-axis title
    salt_plt.update_layout(title=f'Historical Salinity {well}', hovermode="x unified")
    salt_plt.update_xaxes(title_text="<b>Year</b>")
    salt_plt.update_layout(margin={"r":0,"t":50,"l":0,"b":0}, height=500, width=1510)
    # Set y-axes titles
